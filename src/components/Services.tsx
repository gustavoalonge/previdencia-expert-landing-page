...
const Services = () => {
  const services = [
    {
      icon: <Landmark className="w-10 h-10 text-maroon" />,
    ...
    {
      icon: <Gavel className="w-10 h-10 text-maroon" />,
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border-t-4 border-maroon"
            >
